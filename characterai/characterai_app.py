#!/usr/bin/env python3
"""Character.AI Desktop — abre Character.AI no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/characterai-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Character.AI Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Character.AI Desktop", msg)
        sys.exit(1)
