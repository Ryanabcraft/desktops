#!/usr/bin/env python3
"""Google Docs Desktop — abre Google Docs no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/gdocs-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Google Docs Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Google Docs Desktop", msg)
        sys.exit(1)
