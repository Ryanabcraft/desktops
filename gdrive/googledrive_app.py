#!/usr/bin/env python3
"""Google Drive Desktop — abre Google Drive no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/gdrive-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Google Drive Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Google Drive Desktop", msg)
        sys.exit(1)
