#!/usr/bin/env python3
"""AliExpress Desktop — abre AliExpress no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/aliexpress-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"AliExpress Desktop v{new_ver} disponível!\n\n"
