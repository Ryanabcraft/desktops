#!/usr/bin/env python3
"""Wikipedia Desktop — abre Wikipedia no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/wikipedia-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Wikipedia Desktop v{new_ver} disponível!\n\n"
