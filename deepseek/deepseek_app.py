#!/usr/bin/env python3
"""DeepSeek Desktop — abre DeepSeek no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/deepseek-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"DeepSeek Desktop v{new_ver} disponível!\n\n"
