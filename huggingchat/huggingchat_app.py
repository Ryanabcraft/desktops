#!/usr/bin/env python3
"""HuggingChat Desktop — abre HuggingChat no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/huggingchat-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"HuggingChat Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("HuggingChat Desktop", msg)
        sys.exit(1)
