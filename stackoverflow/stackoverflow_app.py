#!/usr/bin/env python3
"""Stack Overflow Desktop — abre Stack Overflow no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/stackoverflow-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Stack Overflow Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Stack Overflow Desktop", msg)
        sys.exit(1)
