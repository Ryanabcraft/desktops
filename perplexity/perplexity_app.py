#!/usr/bin/env python3
"""Perplexity Desktop — abre Perplexity no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/perplexity-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Perplexity Desktop v{new_ver} disponível!\n\n"
