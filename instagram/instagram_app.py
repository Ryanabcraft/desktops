#!/usr/bin/env python3
"""Instagram Desktop — abre Instagram no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/instagram-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Instagram Desktop v{new_ver} disponível!\n\n"
