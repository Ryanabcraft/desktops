#!/usr/bin/env python3
"""SoundCloud Desktop — abre SoundCloud no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/soundcloud-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"SoundCloud Desktop v{new_ver} disponível!\n\n"
